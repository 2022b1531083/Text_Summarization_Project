...
from Text_Summarization_Project.pipeline.stage_04_model_trainer import ModelTrainingPipeline
from Text_Summarization_Project.pipeline.stage_05_model_evaluation import ModelEvaluationTrainingPipeline
